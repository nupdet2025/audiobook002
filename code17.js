...
gdjs.Pagina_95017Code.GDrecome_95231arObjects1= [];
gdjs.Pagina_95017Code.GDrecome_95231arObjects2= [];
gdjs.Pagina_95017Code.GDcreditosObjects1= [];
gdjs.Pagina_95017Code.GDcreditosObjects2= [];


gdjs.Pagina_95017Code.asyncCallback10918860 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Pagina_95017Code.asyncCallback10918860(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Pagina_95017Code.asyncCallback10921292 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Pagina_95017Code.localVariables);
{gdjs.evtTools.sound.stopSoundOnChannel(runtimeScene, 2);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Pagina_95017Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Pagina_95017Code.asyncCallback10921292(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Pagina_95017Code.asyncCallback10922788 = function (runtimeScene, asyncObjectsList) {
asyncObjectsList.restoreLocalVariablesContainers(gdjs.Pagina_95017Code.localVariables);
...
const asyncObjectsList = new gdjs.LongLivedObjectsList();
asyncObjectsList.backupLocalVariablesContainers(gdjs.Pagina_95017Code.localVariables);
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(1), (runtimeScene) => (gdjs.Pagina_95017Code.asyncCallback10922788(runtimeScene, asyncObjectsList)));
}
}
...
};gdjs.Pagina_95017Code.eventsList3 = function(runtimeScene) {
...
if (isConditionTrue_0) {
gdjs.copyArray(runtimeScene.getObjects("creditos"), gdjs.Pagina_95017Code.GDcreditosObjects1);
gdjs.copyArray(runtimeScene.getObjects("pag_01_02"), gdjs.Pagina_95017Code.GDpag_959501_959502Objects1);
gdjs.copyArray(runtimeScene.getObjects("recomeçar"), gdjs.Pagina_95017Code.GDrecome_95231arObjects1);
{for(var i = 0, len = gdjs.Pagina_95017Code.GDpag_959501_959502Objects1.length ;i < len;++i) {
    gdjs.Pagina_95017Code.GDpag_959501_959502Objects1[i].getBehavior("Animation").setAnimationName("volta");
}
}{for(var i = 0, len = gdjs.Pagina_95017Code.GDcreditosObjects1.length ;i < len;++i) {
    gdjs.Pagina_95017Code.GDcreditosObjects1[i].hide();
}
}{for(var i = 0, len = gdjs.Pagina_95017Code.GDrecome_95231arObjects1.length ;i < len;++i) {
    gdjs.Pagina_95017Code.GDrecome_95231arObjects1[i].hide();
}
}{gdjs.evtTools.sound.fadeSoundVolume(runtimeScene, 2, 0, 0.5);
}{gdjs.evtTools.sound.playSound(runtimeScene, "assets\\flip_page.mp3", false, 100, 1);
}
...
let isConditionTrue_0 = false;
isConditionTrue_0 = false;
for (var i = 0, k = 0, l = gdjs.Pagina_95017Code.GDrecome_95231arObjects1.length;i<l;++i) {
    if ( gdjs.Pagina_95017Code.GDrecome_95231arObjects1[i].IsClicked((typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined)) ) {
        isConditionTrue_0 = true;
        gdjs.Pagina_95017Code.GDrecome_95231arObjects1[k] = gdjs.Pagina_95017Code.GDrecome_95231arObjects1[i];
        ++k;
    }
}
gdjs.Pagina_95017Code.GDrecome_95231arObjects1.length = k;
if (isConditionTrue_0) {
...
{ //Subevents
gdjs.Pagina_95017Code.eventsList2(runtimeScene);} //End of subevents
}
...
gdjs.Pagina_95017Code.GDrecome_95231arObjects1.length = 0;
gdjs.Pagina_95017Code.GDrecome_95231arObjects2.length = 0;
gdjs.Pagina_95017Code.GDcreditosObjects1.length = 0;
gdjs.Pagina_95017Code.GDcreditosObjects2.length = 0;

gdjs.Pagina_95017Code.eventsList3(runtimeScene);
gdjs.Pagina_95017Code.GDbackgroundObjects1.length = 0;
gdjs.Pagina_95017Code.GDbackgroundObjects2.length = 0;
gdjs.Pagina_95017Code.GDpag_959501_959502Objects1.length = 0;
gdjs.Pagina_95017Code.GDpag_959501_959502Objects2.length = 0;
